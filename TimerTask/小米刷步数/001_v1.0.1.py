...
data_user = ["18371271507", "15271785883"]
data_pass = ["qwe123456", "123456789cc"]
data_step = ["66666", "56789"]
...
class Step:
    ...
    # 主函数
    def run(self, user, passwd, step):

        # 获取 api 数据
        #with open('api.txt', 'rt') as f:
        ...
        result = f"[{self.now}] 修改步数（{step}）" + response['message']
        print(result)
        return result
    ...
    def get_data_list(self):
        ...
        for i in range(len(data_step)):
            zhangzhang['user'] = data_user[i]
            zhangzhang['passwd'] = data_pass[i]
            zhangzhang['step'] = data_step[i]
            weiwei.append(zhangzhang.copy())
        return weiwei


if __name__ == "__main__":
    zczc = Step()
    for dd in zczc.get_data_list():
        print(dd)
        zczc.run(dd['user'], dd['passwd'], dd['step'])
